...
public class DepthTestInitializer implements PluggableRenderInitializerCall {
    ...
    public DepthTestInitializer() {
    }

    public DepthTestInitializer(Predicate<Renderable> additionalPredicate) {
    ...
    public boolean isProcessing(Renderable renderable) {
        return additionalPredicate == null || additionalPredicate.evaluate(renderable);
    }
}
