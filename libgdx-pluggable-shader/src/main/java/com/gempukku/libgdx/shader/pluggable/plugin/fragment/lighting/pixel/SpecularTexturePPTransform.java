...
public class SpecularTexturePPTransform implements PerPixelLightingCalculateFunctionCall {
    ...
    public void appendFunction(Renderable renderable, FragmentShaderBuilder fragmentShaderBuilder, boolean hasSpecular) {
        ...
        fragmentShaderBuilder.addFunction("applySpecularTexture", GLSLFragmentReader.getFragment("SpecularTexturePPTransform"));
    }
