...
public class ApplyPVDirectionalLights implements PerVertexLightingCalculateFunctionCall {
    ...
    public ApplyPVDirectionalLights(int numDirectionalLights) {
