...
public class DarkSpecularPPSource extends AbstractPluggableFragmentFunctionCall {
    ...
    public DarkSpecularPPSource() {
    }

    public DarkSpecularPPSource(Predicate<Renderable> additionalPredicate) {
    ...
    public void appendFunction(Renderable renderable, FragmentShaderBuilder fragmentShaderBuilder) {
        fragmentShaderBuilder.addFunction("getDarkSpecular",
