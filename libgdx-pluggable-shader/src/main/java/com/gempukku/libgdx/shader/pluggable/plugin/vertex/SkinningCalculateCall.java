...
public class SkinningCalculateCall extends AbstractPluggableVertexFunctionCall {
    private int boneMaxCount;
    private PluggableShaderFeatureRegistry.PluggableShaderFeature[] boneCountFeatures;

    public SkinningCalculateCall(int boneMaxCount, Predicate<Renderable> additionalPredicate) {
