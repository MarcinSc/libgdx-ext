...
public class OpenGLPool {
    private List<DefaultRenderBuffer> oldRenderBuffers = new LinkedList<DefaultRenderBuffer>();
    private List<DefaultRenderBuffer> newRenderBuffers = new LinkedList<DefaultRenderBuffer>();

    private List<Texture> oldColorTextures = new LinkedList<Texture>();
    private List<Texture> newColorTextures = new LinkedList<Texture>();

    private List<Texture> oldDepthStencilTextures = new LinkedList<Texture>();
    private List<Texture> newDepthStencilTextures = new LinkedList<Texture>();
