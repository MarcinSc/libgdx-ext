...
public class CelShadingCountPPDiffuseTransform implements PerPixelLightingCalculateFunctionCall {
    private CelShadingCountDiffuseTransform celShadingCountDiffuseTransform;

    public CelShadingCountPPDiffuseTransform(int shadeCountMaximum) {
