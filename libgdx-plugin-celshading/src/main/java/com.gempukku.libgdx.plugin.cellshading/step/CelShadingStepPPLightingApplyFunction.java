...
public class CelShadingStepPPLightingApplyFunction implements PerPixelLightingApplyFunction {
    private CelShadingStepLightingApplyFunction celShadingStepLightingApplyFunction;

    public CelShadingStepPPLightingApplyFunction(int shadeCountMaximum) {
    ...
    public void appendFunction(Renderable renderable, FragmentShaderBuilder fragmentShaderBuilder, boolean hasSpecular) {
        celShadingStepLightingApplyFunction.appendPerPixelFunction(renderable, fragmentShaderBuilder, hasSpecular);
    }
